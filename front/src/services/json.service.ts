...
export async function readLocalJSONData(localJSONPath: string) {
...
export async function readRemoteJSONData(remoteJSONPath: string) {
...
export async function writeLocalJSONData(localJSONPath: string, data: any) {
...
export async function checkJSONVersion(
  ...
  const remoteJson = await readRemoteJSONData(remoteJSONPath);
